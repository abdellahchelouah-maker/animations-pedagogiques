...
ELECTRONIQUE_DIR = BASE_DIR / "pages" / "electronique"

# 2) Fichiers à traiter dans pages/electronique
FILES_TO_PROCESS = [
    "electronique-1-mesurages.html",
    "electronique-2-cours-cpld.html",
    "electronique-3-cours-hacheur.html",
    "electronique-4-cours-microcontroleur.html",
    "electronique-5-cours-microcontroleur.html",
]
...
def build_new_form(slug: str) -> str:
    """Construit le formulaire Formspree pour une page donnée."""
...
def main():
    if not ELECTRONIQUE_DIR.is_dir():
        print(f"Le dossier {ELECTRONIQUE_DIR} n’existe pas.")
        return

    for filename in FILES_TO_PROCESS:
        file_path = ELECTRONIQUE_DIR / filename
